...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Magazine Archive | Dental Reach" }, { "default": async ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="relative py-20 bg-tuio-navy overflow-hidden"> <div class="absolute inset-0 z-0"> <div class="absolute inset-0 bg-[url('/images/pattern-bg.png')] opacity-10"></div> <div class="absolute inset-0 bg-gradient-to-b from-transparent to-tuio-navy/90"></div> </div> <div class="container mx-auto px-4 relative z-10 text-center"> <span class="inline-block px-4 py-2 rounded-full bg-tuio-red/10 text-tuio-red text-sm font-bold uppercase tracking-wider mb-6 backdrop-blur-sm border border-tuio-red/20">
Archive
</span> <h1 class="text-4xl md:text-6xl font-tuio text-white mb-6 uppercase">
Magazine Issues
