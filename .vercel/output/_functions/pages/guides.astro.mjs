...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (guides.length === 0) {
    guides = [
      { title: "Complete Guide to Dental SEO", slug: "dental-seo-guide", excerpt: "Learn how to rank your dental practice on Google.", image_url: "https://images.pexels.com/photos/265087/pexels-photo-265087.jpeg?auto=compress&cs=tinysrgb&w=800", published_at: "2026-01-15", category: { name: "Marketing" } },
      { title: "How to Start a Dental Practice", slug: "start-dental-practice", excerpt: "Step-by-step guide for new dental entrepreneurs.", image_url: "https://images.pexels.com/photos/3845653/pexels-photo-3845653.jpeg?auto=compress&cs=tinysrgb&w=800", published_at: "2026-01-10", category: { name: "Business" } },
      { title: "Mastering Patient Communication", slug: "patient-communication", excerpt: "Build trust and improve treatment acceptance rates.", image_url: "https://images.pexels.com/photos/5355834/pexels-photo-5355834.jpeg?auto=compress&cs=tinysrgb&w=800", published_at: "2026-01-05", category: { name: "Practice" } },
      { title: "Infection Control Best Practices", slug: "infection-control", excerpt: "Updated protocols for modern dental practices.", image_url: "https://images.pexels.com/photos/4226264/pexels-photo-4226264.jpeg?auto=compress&cs=tinysrgb&w=800", published_at: "2025-12-20", category: { name: "Clinical" } }
    ];
  }
